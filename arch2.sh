...
read -p "1 - XFCE, 2 - KDE, 3 - lxqt, 4 - Openbox: " vm_setting
...
echo 'Если хотите подключить AUR (yay), и менеджер программ Pamac, тогда после перезагрзки и входа в систему, установите wget (sudo pacman -S wget) и выполните команду:'
echo 'wget git LinuxSimple.github.io/arch3.sh && sh arch3.sh'
exit
